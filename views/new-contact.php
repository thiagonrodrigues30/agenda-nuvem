    ...
    <div class="container-fluid" style="margin-top: 6em;">
        <div class="row"> 
            ...
            <div class="col-md-10 col-md-offset-1">
                ...
                <form action="new-contact.php" name="form1" id="form1" method="POST" enctype="multipart/form-data">
                    <fieldset>
                        <?php
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" id="name" name="name" pattern="[a-zA-Z\s]{2,64}" required title="Apenas letras e espaços. Caracteres especiais e acentos não são aceitos"/><br/>
                        </div>

                        <div class="form-group">
                            <label for="nickname">Apelido:</label><br/>
                            <input class="form-control" type="text" id="nickname" name="nickname" pattern="[a-zA-Z\s]{2,64}" required title="Apenas letras e espaços. Caracteres especiais e acentos não são aceitos"/><br/>
                        </div>

                        <div class="form-group">
                            <label for="email">Email:</label><br/>
                            <input class="form-control" type="text" id="email" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" placeholder="email@example.com" title="email@example.com" required/><br/>
                        </div>

                        <div class="form-group">
                            <label for="telephone">Telefone para contato:</label><br/>
                            <input class="form-control" type="text" id="telephone" name="telephone" pattern="{6,15}" required/><br/>
                        </div>

                        <div class="form-group">
                            <label for="day">Data de aniversário:</label><br/>
                            <input class="form-control date-config" type="text" id="day" name="day" pattern="[0-9]{2,2}" placeholder="Dia" title="Dois números" required/>
                            <input class="form-control date-config" type="text" id="month" name="month" pattern="[0-9]{2,2}" placeholder="Mês" title="Dois números" required/>
                        ...
                        <div class="form-group" id="declaracao_socio_form">
                            <label for="photo">Foto Pessoal:</label>
                        ...
                        <div class="col-md-12">
                            ...
                            <center>
                                ...
                                <div class="col-md-2" >
                                <input type="submit" class="btn btn-primary btn-size1" name="register" id="register" value="Cadastrar" />
                                </div>
